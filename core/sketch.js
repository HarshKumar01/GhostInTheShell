  ...
  if (humanPlaying) {
    ...
    if (
      ...
      if (testPopulation.genPlayers.length <= upToGenPos) {
        ...
        genPlayer = testPopulation.genPlayers[upToGenPos].reproduce();
    ...
    // console.log(testPopulation.players[0].brain.directions);
    //genetic algorithm
    testPopulation.calculateFitness();
    testPopulation.naturalSelection();
    testPopulation.mutatethebabies();
    //reset dots
    resetDots();
    ...
    switch (key) {
      ...
      case "G": //replay gens
        if (replayGens) {
          ...
          replayGens = true;
          genPlayer = testPopulation.genPlayers[0].reproduce();
          saveDots();
          resetDots();
        }
        break;
